...
export const consistencyCards: Card[] = [
  {
    ...
    speed: [
      ...
      {
        question: "Under CAP, why is partition tolerance not really a choice?",
        correct:
          "Real networks drop packets, so a partition will happen whether you planned for it or not",
        distractors: [
          "Because every modern database implements it by default",
          "Because it only matters once you deploy across regions",
          "Because consistency and availability both depend on it being enabled",
        ],
      },
      {
        question: "Is a system 'AP' or 'CP' as a whole?",
        correct:
          "Almost never — different operations on different data should make different choices",
        distractors: [
          "Yes, it is a property of the database engine you picked",
          "Yes, it is fixed by the replication mode at deployment",
          "Only multi-region systems can mix the two",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    speed: [
      {
        question:
          "What does a violation of monotonic reads look like to a user?",
        correct:
