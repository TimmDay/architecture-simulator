...
export const messagingCards: Card[] = [
  ...
  },
  {
    ...
    speed: [
      ...
      {
        question:
          "Why can exactly-once DELIVERY not be guaranteed over a network?",
        correct:
          "The sender can never distinguish a lost message from a lost acknowledgement",
        distractors: [
          "Clocks drift, so duplicate detection windows cannot be trusted",
          "Brokers reorder messages under load",
          "It can be, using two-phase commit between broker and consumer",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    speed: [
      ...
      },
      {
        ...
        correct:
          "A poison message blocking everything behind it in the partition",
        distractors: [
          "Messages arriving faster than consumers can process them",
          "Consumers crashing before committing their offsets",
          "Duplicate delivery after a rebalance",
        ],
      },
    ],
  },
